...
CREATE TABLE professeurs (
    ...
    genre ENUM('M','F'),
    fonctionnaire ENUM('OUI', 'NON'),
    diplom ENUM('Licence','Master','Ingenieur','Doctorant','MC','MCH','PES'),
    statut ENUM('Permanant','Vacataire','Boursier Excellence') NOT NULL,
...
INSERT INTO professeurs (nom, prenom, email, n_somme) VALUES
('AIRAJ', 'MOHAMMED', '',),
('ALFIDI', 'Mohammed', '',),
('BERRADA', 'Mohammed', '',),
('CHALH', 'Zakaria', '', ),
